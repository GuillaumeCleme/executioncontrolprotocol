...
round-trips to a valid `@ecp.workflow`.
...
* Encode omits `ECP @ecp.workflow 1.0`.
* Decode succeeds without header when `to: "@ecp.workflow"` is provided.
...
compiles to canonical `@ecp.patch`.
