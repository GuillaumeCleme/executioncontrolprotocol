...
The implementation report states workflow manifests are portable `@ecp.workflow` JSON and repeats that workflow manifests do not contain runtime config, extension config, policies, or secrets. 
