...
const SYSTEM_PROMPT_CHAR_BUDGET: Record<string, number> = {
  ...
  [HARNESS_PROMPT_FIXTURE_IDS.INTENT_CLASSIFICATION_CODING]: 16_000,
  [HARNESS_PROMPT_FIXTURE_IDS.WORKFLOW_AUTHORING_CREATE_CODING]: 18_000,
  [HARNESS_PROMPT_FIXTURE_IDS.WORKFLOW_AUTHORING_PATCH_CODING]: 16_000,
  [HARNESS_PROMPT_FIXTURE_IDS.WORKFLOW_ASSISTANT_CODING]: 18_000,
}
