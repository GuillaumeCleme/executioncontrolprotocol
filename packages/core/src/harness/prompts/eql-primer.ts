...
export const EQL_ZERO_KNOWLEDGE_INTRO = [
  ...
  "- Capability ids are exact strings from the environment list (e.g. @executioncontrolprotocol/demo.echo). Never invent ids.",
...
export const EQL_PATCH_CANONICAL_EXAMPLES = [
  ...
  "User: Add a summarize step after echo using @executioncontrolprotocol/demo.summarize.",
  "Output:",
