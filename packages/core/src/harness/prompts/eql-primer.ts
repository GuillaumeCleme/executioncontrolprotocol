...
export const EQL_ZERO_KNOWLEDGE_INTRO = [
  ...
  "- Capability ids are exact strings from the environment list (e.g. @ecp/test.echo). Never invent ids.",
...
export const EQL_PATCH_CANONICAL_EXAMPLES = [
  ...
  "User: Add a summarize step after echo using @ecp/demo.summarize.",
  "Output:",
  "PATCH WORKFLOW echo-test",
  "ADD STEP summarize USES @ecp/demo.summarize AFTER echo",
  "  LABEL \"Summarize\"",
