...
/** Eval workflow assistant harness id. @category Evals */
export const EVALS_WORKFLOW_ASSISTANT_ID = "@ecp/evals-workflow-assistant" as HarnessId
...
/** Evaluate capability for eval workflow assistant. @category Evals */
export const EVALS_WORKFLOW_ASSISTANT_CAPABILITY = harnessCapabilityId(EVALS_WORKFLOW_ASSISTANT_ID)
