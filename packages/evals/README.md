...
| `@executioncontrolprotocol/demo` | Demo ops: `echo`, `summarize`, `translate`, `notify`, `validate` (not the LLM provider) |

Legacy smoke environments use `@executioncontrolprotocol/format-toon` + `@executioncontrolprotocol/demo` only.
